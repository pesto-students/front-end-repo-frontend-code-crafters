...
const Footer = () => {
  return (
    <div className="absolute top-[0px] left-[0px] bg-gray-scale-white w-[1920px] h-[1100px] overflow-hidden">
        <div className=" top-[611px] absolute  bg-zinc-900 w-[1920px] h-[399px] overflow-hidden text-gray-scale-white">
